...
if(isset($_POST["fname"])) {
    ...
    echo ($send_email) ? '<div class="success alert alert-success">Email has been sent successfully.</div>' : '<div class="failed alert alert-danger">Error: Email did not Send.</div>';
}
else
{
